...
echo "============================================"
author : MAMANG IPONG
github : https://github.com/jakekuatom
yTUBE : hack 606
============================================"
...
case $pill in
1)clear
git clone https://github.com/jakekuatom/fbbrute
cd fbbrute
...
2)clear
git clone https://github.com/jakekuatom/camera
cd gmail
sh camera.sh
...
3)clear
git clone https://jakekuatom/deface
cd deface
sh tebas.sh
